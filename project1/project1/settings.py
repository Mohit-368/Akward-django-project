...
SECRET_KEY = 'django-insecure-h-trrcn&_^wnp9w!d34eiqsp+#lkrkz&yp#ek_40zujn!6b!l-'
DEBUG = True
ALLOWED_HOSTS = []
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'berwaliamohit@gmail.com'
EMAIL_HOST_PASSWORD = 'cnva mnfi qxfb zowt'
